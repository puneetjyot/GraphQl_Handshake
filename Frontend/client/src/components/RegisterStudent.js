...
import { registerStudentMutation } from '../mutation/mutations';
...
class RegisterStudent extends Component {
  ...
  handleSubmit = async e => {
    e.preventDefault();
    let mutationResponse = await this.props.registerStudentMutation({
      variables: {
...
export default graphql(registerStudentMutation, { name: "registerStudentMutation" })(RegisterStudent);
